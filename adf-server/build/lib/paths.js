...
export const ADF_ROOT = normalizePath(process.env.ADF_ROOT || "~/code/_shared/adf");
export const REGISTRY_ROOT = normalizePath(process.env.ADF_REGISTRY_ROOT || "~/code/_shared/capabilities-registry");
/**
 ...
 */
export async function validatePathWithinBase(candidate, base) {
