...
| B51 | Update ACM MCP server get_stage enum to include deliver | 2026-02-02 | Completed with B39 — same changeset. get_stage now accepts "deliver" and serves ADF-DELIVER-SPEC.md. |
...
| B40 | Update ADF-STAGES-SPEC.md environment layer references | 2026-01-31 | ACM MCP server added alongside acm-env. |
